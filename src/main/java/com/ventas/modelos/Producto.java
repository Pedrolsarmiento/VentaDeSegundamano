...
public class Producto {
	...
	public Producto(@NotNull String nombre, @NotNull @Min(0) float precio, String imagen, Usuario usuario) {
		super();
		this.nombre = nombre;
		this.precio = precio;
		this.imagen = imagen;
	...
	public String toString() {
		return "Producto [id=" + id + ", nombre=" + nombre + ", precio=" + precio + ", imagen=" + imagen + ", usuario="
				+ propietario + ", compra=" + compra + "]";
	}
