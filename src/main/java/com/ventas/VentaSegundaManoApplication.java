...
import com.ventas.servicios.ProductoServicio;
import com.ventas.servicios.UsuarioServicio;

@SpringBootApplication
public class VentaSegundaManoApplication {

	public static void main(String[] args) {
		SpringApplication.run(VentaSegundaManoApplication.class, args);
	}
	...
	public CommandLineRunner initData(UsuarioServicio usuarioServicio, ProductoServicio productoServicio) {
		return args -> {
			...
			List<Producto> listado = Arrays.asList(new Producto("Bicicleta de montaña", 100.0f,
					"https://images-na.ssl-images-amazon.com/images/I/81AqSbddf2L._AC_SX522_.jpg", usuario),
